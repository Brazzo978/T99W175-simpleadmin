...
PAYLOAD_ARCHIVE="${1:-$SCRIPT_DIR/simpleadmin-1.0.6-payload.tar.gz}"
REMOTE_ARCHIVE="/tmp/simpleadmin-1.0.6-payload.tar.gz"
REMOTE_DIR="/tmp/simpleadmin-1.0.6-payload"
